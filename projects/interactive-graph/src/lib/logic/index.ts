...
export {ImageSimpleDirectedEdge} from './predefined/edge/imageEdge/imageSimpleDirectedEdge'
export {ImageSimpleDirectedWeightedEdge} from './predefined/edge/imageEdge/imageSimpleDirectedWeightedEdge'
export {ImageSimpleUndirectedEdge} from './predefined/edge/imageEdge/imageSimpleUndirectedEdge'
export {ImageSimpleUndirectedTreeEdge} from './predefined/edge/imageEdge/imageSimpleUndirectedTreeEdge'
export {ImageSimpleUndirectedWeightedEdge} from './predefined/edge/imageEdge/imageSimpleUndirectedWeightedEdge'
